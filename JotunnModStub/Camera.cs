...
namespace BuildIt
{
    ...
    {
			private const string MID = "RockerKitten.BuildIt";
			private const string PluginName = "Camera";

			private static ConfigFile configFile = new ConfigFile(Path.Combine(Paths.ConfigPath, "BuildItCamera.cfg"), true);
			...
			//private static ConfigEntry<string> buildTools = configFile.Bind("Tools", "Build_Tools_List",
			//	"$item_hammer, $item_cultivator, $item_hoe, $PlumgaPlantItShovel, $PlumgaClutterTool, $rainbow_hammer, $ImprovedHammer"),
			//	"List the name of each tool you want to be able to use Build Camera with.";
			...
			static readonly String[] toolNames
				= new String[] { "$PlumgaPlantItShovel", "$PlumgaClutterTool", "$rainbow_hammer", "$ImprovedHammer" };
